 ...
 */
package com.framework.modules.ucenter.weichat.entity;
 ...
 * @version 2017-04-24
 */
public class WechatSetting extends DataEntity<WechatSetting> {
	
	private static final long serialVersionUID = 1L;
	private String name;		// 名称
	private String appid;		// 微信平台的APPID
	...
	public WechatSetting(String id){
		super(id);
	}
	...
	@Length(min=1, max=200, message="微信平台的APPID长度必须介于 1 和 200 之间")
	@ExcelField(title="微信平台的APPID", align=2, sort=2)
