...
<body>
		<form:form id="inputForm" modelAttribute="weiboUser" action="${ctx}/ucenter/weibouser/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				...
				<tr>
					<td class="width-15 active"><label class="pull-right">授权信息：</label></td>
					<td class="width-35">
				...
				<tr>
					...
					<td class="width-35" colspan="3">
						<form:textarea path="signature"  cols="56" rows="6" class="form-control "></form:textarea>
					</td>
				</tr>
		 	</tbody>
		</table>
